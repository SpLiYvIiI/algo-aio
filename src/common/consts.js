...
const bubbleSortWorstComplexity =
  'საშუალო და უარესი შემთხვევაა n² (უარეს შემთხვევაში მონაცემები შებრუნებულად არის დალაგებული).';
...
const heapSortWorstComplexity =
  'საუკეთესო, საშუალო და უარესი შემთხვევაა nLogn (მონაცემთა მიმდევრობა არ ახდენს გავლენას ალგორითმის მუშაობის სიჩქარეზე).';
...
const insertionSortWorstComplexity =
  'საშუალო და უარესი შემთხვევაა n² (უარეს შემთხვევაში მონაცემები პირიქითაა დალაგებული).';

const insertionSortBestComplexity =
  'საუკეთესო შემთხვევაა n (თუ მონაცემები უკვე დალაგებული არის).';
...
const quickSortWorstComplexity =
  'უარეს შემთხვევაში არის n² (თუ მონაცემები უკვე დალაგებულია ან დალაგაებულია შებრუნებულად).';

const quickSortBestComplexity = 'საუკეთესო და საშუალო შემთხვევაა nLogn .';
...
<<<<<<< HEAD
  'საუკეთესო, საშუალო და უარესი შემთხვევაა n² (მონაცემთა მიმდევრობა არ ახდენს გავლენას ალგორითმის მუშაობის სიჩქარეზე).';
=======
...
>>>>>>> 6aa481ff5ddd49288c9f44f2167064144c0eef7d
